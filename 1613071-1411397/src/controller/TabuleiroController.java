...
public class TabuleiroController
	...
	private void movimentaPeca() {
		...
		try {
			jogo.tabuleiro[xOrig][yOrig].movimento(xOrig, yOrig, xDest, yDest,
					jogo.tabuleiro);
		...
		if (pecaSelecionada == false) {
			...
			if (jogo.tabuleiro[xOrig][yOrig] != null) {
				if (jogo.tabuleiro[xOrig][yOrig].getCor() != jogo.rodadaAtual) {
					System.out.println(
							"A jogada e dxs " + jogo.rodadaAtual.toString());
					return;
				}
				pecaSelecionada = true;

				Boolean[][] posicoes = posicoesPossiveis(jogo.tabuleiro, xOrig,
						yOrig);
			...
			if (jogo.tabuleiro[x][y] != null) {
				if (jogo.tabuleiro[x][y]
						.getCor() == jogo.tabuleiro[xOrig][yOrig].getCor()) {
					xOrig = x;
					yOrig = y;

					Boolean[][] posicoes = posicoesPossiveis(jogo.tabuleiro,
							xOrig, yOrig);
					janela.tabuleiro.setPosicoesPossiveis(posicoes);
				} else {
					xDest = x;
	...
	public Boolean[][] posicoesPossiveis(Peca[][] tabuleiro, int xOrig,
			int yOrig) {
